...
export default function AdminUploadModal({ modelKey }) {
    ...
    return (
        <div style={{ maxWidth: 600, margin: '0 auto', padding: 20 }}>
            ...
            {/* FORMULAIRE UPLOAD */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 20, backgroundColor: 'white', padding: 20, borderRadius: 8 }}>
                <input
                    type="text"
                    placeholder="Titre"
                    value={title}
                ...
                {file ? (
                    ...
                    <label style={{ border: '2px dashed #ccc', padding: 20, textAlign: 'center', cursor: 'pointer', borderRadius: 8 }}>
                ...
                <button
                    ...
                    disabled={loading}
                    style={{ backgroundColor: '#00ae5e', color: 'white', padding: 10, borderRadius: 5, border: 'none' }}
                >
